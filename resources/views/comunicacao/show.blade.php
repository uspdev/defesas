...
<div class="container">
    <div class="card">
    <div class="card-header"><b class="text-center">Informações sobre o agendamento</b></div>
        <div class="card-body">
            <div class="row">
                <div class="col">
                    ...
                    <p><b>Data da publicação:</b> {{ date('d/m/Y', strtotime($agendamento->data_publicacao)) }}</p>
