<div class="card">
        ...
        <div class="card-body">
            <a href="/agendamentos/{{ $agendamento->id }}/bancas/create" class="btn btn-outline-success">Inserir Professor</a>
            <br>
            <br>
            <table class="table table-striped" style="text-align: center;">
                ...
                @foreach ($agendamento->bancas as $banca)
                    <tr>
                        ...
                        <td>
                            <a href="/agendamentos/{{$agendamento->id}}/bancas/{{$banca->id}}/edit" class="btn btn-outline-warning">Editar</a>
                        </td>
                        <td>
                            <form method="POST" action="/agendamentos/{{ $agendamento->id }}/bancas/{{$banca->id}}">
                                @csrf 
                                @method('delete')
                                <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Você tem certeza que deseja apagar?')">Apagar</button>
                            </form>
                        </td>
                    </tr>
                @endforeach
