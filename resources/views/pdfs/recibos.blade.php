...
@foreach($professores as $professor)
	...
	<br>  {{$endereco['cidloc']}}
	- {{$endereco['sglest']}}
		<div style="text-indent:1.5cm;"> A/C: Prof(a). Dr(a). {{$pessoa::dump($professor->codpes)['nompes']}} </div> </td> 
        </tr> 
    </table>
	<table width="18cm" class="negrito">
		<tr>
   	 <td> <u>ASSUNTO:</u> encaminho exemplar do trabalho do aluno(a) Sr(a). {{$pessoa::dump($agendamento->codpes)['nompes']}} </td> 
		</tr> </table>
