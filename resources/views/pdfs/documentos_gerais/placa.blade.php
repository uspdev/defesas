...
<html lang="en">
	...
	<body>
		<div class="content"> </div>
			...
			<br><br><br>
			<div class="candidato">Candidato(a): {{ $agendamento->nome }}</div> <div class="candidato">Data e Hora: {{date('d/m/Y H:i', strtotime($agendamento->data_horario))}}.</div> <div class="candidato">Defesa de {{ $agendamento->nivpgm }} em {{ $agendamento->area['nomare'] }}</div>
