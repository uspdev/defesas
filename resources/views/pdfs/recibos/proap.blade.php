...
@section('content')
  <div id="proap">
    ...
    <table width="16.5cm" style="border:0px;">
      <tr>
        <td style="border:0px;" colspan="2">Nome do Convidado: {{ $docente['nompesttd'] ?? 'Professor não cadastrado'}} </td>
      </tr>
      <tr>
        <td style="border:0px;"> CPF: {{ $docente['documentos']['numcpf'] ?? ' '}}</td>
        <td style="border:0px;">  RG: {{ $docente['documentos']['numdocidf'] ?? ' '}}  </td>
      </tr>
    </table>
    <hr>
    <table width="16.5cm" style="border:0px;">
      <tr>
        ...
        <td style="border:0px;"> {{ $docente['setor']['sglclgund'] }} {{ ($docente['tipvin'] == 'SERVIDOR') ? ' - USP' : '' }} </td>
    ...
    <table width="18cm">
      <tr>
        <td style="border:none;"> <hr style="width:10cm;">
          {{ $docente['nompesttd'] ?? 'Professor não cadastrado'}} <br>
